    ...
    >
      ...
      <template v-slot:[`item.fregionBean`]="{ item }">
        <span class="text-caption">
          {{ lookupFRegion(item.fregionBean).description }}
        </span>
      </template>
  ...
  data () {
    return {
      ...
      headers: [
        ...
        { title: 'Kecamatan', value: 'description', width:"30%" },
        // { title: 'Alias 1&2', value: 'alias1', width:"20%" },
        { title: 'Kebupaten/Kota', value: 'fregionBean', width: "25%" },
        { title: 'Aktif', value: 'statusActive', width: "20%" },
