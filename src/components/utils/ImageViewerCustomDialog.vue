<template>
  <v-dialog :style="{ zIndex: 250 }" v-model="dialogShow" :fullscreen="fullscreen || $vuetify.display.smAndDown" :max-width="maxWidth" :height="height" transition="dialog-top-transition">
