        ...
        <v-card elevation="0" width="280" class="bg-transparent ma-md-2 ma-1">
            ...
            <v-card-text class="bg-white mt-3 py-4 rounded-lg">
              ...
              <v-card elevation="0" class="d-flex flex-row justify-center align-center bg-grey-lighten-5 mt-2" height="45vh">
                <v-card-text class="text-center">
                  <v-btn readonly class="color-bg-second mb-6" icon variant="flat" size="small"><v-icon class="text-white">mdi-map</v-icon></v-btn>
                  ...
                  <v-btn @click="showDialogPickMapset" class="color-bg-primary text-white text-subtitle-2 rounded-lg mt-6 font-weight bold" density="comfortable" variant="elevated">Pilih Mapset</v-btn>
                </v-card-text>
              </v-card>
            </v-card-text>
          </v-expand-transition>
          <v-expand-transition v-show="showMapsetController === true">
            <v-card-text class="bg-white mt-3 py-4 rounded-lg">
              ...
              <v-btn block variant="elevated" class="mt-2" color="blue-darken-1">Upload Peta</v-btn>
            </v-card-text>
          </v-expand-transition>
        </v-card>
      </l-control>
