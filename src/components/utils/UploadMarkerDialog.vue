    ...
    >
      <v-card>
        ...
        >
          ...
          <v-toolbar-title>Upload Marker Webp</v-toolbar-title>
          <v-spacer></v-spacer>
        </v-toolbar>
        ...
        <v-card-text class="justify-center">
          ...
          <v-file-upload clearable v-model="currentImage" density="compact" accept=".png, .jpg, .jpeg"></v-file-upload>
