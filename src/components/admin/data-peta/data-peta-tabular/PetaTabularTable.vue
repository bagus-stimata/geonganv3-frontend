...
import PetaTabularDialog from "./PetaTabularDialog.vue";
...
export default {
  components: {
    FDayaDukungPetaDialog: PetaTabularDialog,
    DeleteConfirmDialog,
  },
  data() {
    return {
      ...
      headers: [
        ...
        { title: "Jenis", key: "fdayaDukungTypeBean" },
        { title: "Kecamatan", key: "fareaBean" },
        { title: "Pemilik Data", key: "fdivisionBean" },
  ...
  methods: {
    ...
    runExtendedFilter() {
      ...
      FDayaDukungService.getPostAllFDayaDukungContainingExtNonGeojson(
          extendedFilter
      ).then(
          (response) => {
